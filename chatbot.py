...
responses = [
    ...
    (r'(?i)whats your name', 'I’m Grok, your friendly AI chatbot!'),
    ...
    (r'(?i)what is the weather', 'I can’t check the weather, but tell me your city, and I’ll suggest what to wear!'),
    (r'(?i)chennai', 'tshirts with jeans'),
    (r'(?i)help me', 'I’m here to help! Ask me anything, like "What’s your name?" or "Tell me a joke!"'),
    (r'(?i)tell me joke', 'Joke'),
